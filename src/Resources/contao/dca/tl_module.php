...
$GLOBALS['TL_DCA']['tl_module']['palettes']['apartments_list'] = '{title_legend},name,headline,type,jumpTo,hide_bewerben;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID';

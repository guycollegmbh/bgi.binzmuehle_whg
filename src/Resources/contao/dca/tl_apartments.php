...
$GLOBALS['TL_DCA']['tl_apartments'] = [
    ...
    'palettes' => [
        'default' => '{beschreibung_legend},objektnummer,bezeichnung,bauetappe,zeile;{zusaetlicheinformationen_legend},adresse,etage,zimmer,flaeche;{detailseite_legend},nettomietzins,nebenkosten,bruttomietzins;{links_legend},grundriss;{published_legend},published',
    ],
    'fields' => [
        'id' => [
